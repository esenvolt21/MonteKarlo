...
// IzingModel.cpp: определяет поведение классов для приложения.
//
...
BEGIN_MESSAGE_MAP(CIzingModelApp, CWinApp)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()


// Создание CIzingModelApp

CIzingModelApp::CIzingModelApp()
{
...
// Единственный объект CIzingModelApp

CIzingModelApp theApp;


// Инициализация CIzingModelApp

BOOL CIzingModelApp::InitInstance()
{
